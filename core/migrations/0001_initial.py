    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('country', models.CharField(blank=True, help_text='what country', max_length=255, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Location',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source', models.CharField(choices=[('SCR', 'Scraped'), ('USR', 'User Submitted'), ('PRT', 'Partner')], default='USR', max_length=255)),
                ('scrape_source', models.CharField(choices=[('mlh', 'MLH'), ('dev', 'Devpost'), ('eth', 'ETHGlobal'), ('hcl', 'Hack Club'), ('na', 'Not Applicable')], default='na', max_length=255)),
                ...
                ('fg_image', models.ImageField(blank=True, max_length=500, null=True, upload_to='hackathon_images')),
                ('bg_image', models.ImageField(blank=True, max_length=500, null=True, upload_to='hackathon_images')),
